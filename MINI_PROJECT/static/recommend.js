$(function () {
  ...
  // To activate button as soon as some text is typed in the input
  ...
  $('.movie-button').on('click', function () {
    ...
    var my_api_key = '408fa959ea59624047b8506f858470ca';
    var title = $('.movie').val();
    if (title == "") {
...
window.onload = function () {
  ...
  if (pathname == '/home') {
    let topliked = document.getElementById("top-liked");
    topliked.style.display = 'none';
    let toprecommended = document.getElementById("top-recommended");
    toprecommended.style.display = 'none';
    ...
    let topliked = document.getElementById("top-liked");
    topliked.style.display = 'block';
    let toprecommended = document.getElementById("top-recommended");
    toprecommended.style.display = 'block';
    let scrolldown = document.getElementById("scroll-down");
